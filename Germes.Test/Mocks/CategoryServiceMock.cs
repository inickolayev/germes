...
//        public static readonly Dictionary<SessionModel, List<ExpenseCategoryModel>> ExpenseCategoriesDb = new Dictionary<SessionModel, List<ExpenseCategoryModel>>();
//        public static readonly Dictionary<SessionModel, List<IncomeCategoryModel>> IncomeCategoriesDb = new Dictionary<SessionModel, List<IncomeCategoryModel>>();
